...
Write **one line per panel** naming the motif (panel `-a` may be almost-plain
haze of the place palette). If a teacher **cannot name the place from the motif
list alone**, reject the plan and rewrite the vocabulary — do not generate yet.
