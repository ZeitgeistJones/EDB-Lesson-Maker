...
/**
 * Drop plain page-N.jpg/png at or above pageCount (Manus UX fruit/face/dentist:
 * phonics omit / shorter decks left stale wrap JPGs that pickImages still sent →
 * false "duplicate Wrap Up" blockers).
 */
export function clearOrphanPageJpgs(outDir, pageCount) {
  if (!fs.existsSync(outDir)) return;
