/**
 * Beach: sand must not resolve marina-bay-sands; kit may bank sandcastle;
 * soft-gate (SHIPPABLE_KING_KEYS) does not ship beach as heroProp yet.
...
assert(!hero, `beach king deferred (no SHIPPABLE dock), got ${hero && hero.key}`);
...
console.log('OK beach soft-gate', { shippableHero: null, kitPack: kit.pack, kitHero: kit.hero.key, docks: kit.dockCount });
