/**
 * Shift60 vocab-gaps wave84 — roast dinner + farm insects pests + train travel.
 *   node scripts/manus/request-shift60-vocab-gaps-wave84.mjs
 */
import fs from 'fs';
...
const OUT_DIR = path.join(ROOT, 'tmp', 'manus-shift60-vocab-gaps-wave84');
...
const dumpBase = { started_at: new Date().toISOString(), agent_profile: profile, force_skills: force, quality: 'default', wave: 84, shift: 60 };
...
const created = await createTask({
  title: 'ESL white vocab 3×3: Shift60 vocab-gaps wave84 RETRY of wave67 (roast/pests/train)',
  message: BRIEF,
