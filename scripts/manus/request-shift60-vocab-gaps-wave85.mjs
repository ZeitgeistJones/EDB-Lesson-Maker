/**
 * Shift60 vocab-gaps wave85 — tapas + arctic gear + playground more.
 *   node scripts/manus/request-shift60-vocab-gaps-wave85.mjs
 */
import fs from 'fs';
...
const OUT_DIR = path.join(ROOT, 'tmp', 'manus-shift60-vocab-gaps-wave85');
...
const dumpBase = { started_at: new Date().toISOString(), agent_profile: profile, force_skills: force, quality: 'default', wave: 85, shift: 60 };
...
const created = await createTask({
  title: 'ESL white vocab 3×3: Shift60 vocab-gaps wave85 RETRY of wave70 (tapas/arctic/playground)',
  message: BRIEF,
