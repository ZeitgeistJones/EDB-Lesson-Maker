/**
 * Shift60 vocab-gaps wave81 — bakery + tools + playground.
 *   node scripts/manus/request-shift60-vocab-gaps-wave81.mjs
 */
import fs from 'fs';
...
const OUT_DIR = path.join(ROOT, 'tmp', 'manus-shift60-vocab-gaps-wave81');
...
const dumpBase = { started_at: new Date().toISOString(), agent_profile: profile, force_skills: force, quality: 'default', wave: 81, shift: 60 };
...
const created = await createTask({
  title: 'ESL white vocab 3×3: Shift60 vocab-gaps wave81 RETRY of wave14 (bakery/tools/playground)',
  message: BRIEF,
