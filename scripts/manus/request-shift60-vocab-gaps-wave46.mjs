/**
 * Shift60 vocab-gaps wave46 — breakfast extras + vet clinic + photography.
 *   node scripts/manus/request-shift60-vocab-gaps-wave46.mjs
 */
import fs from 'fs';
...
const OUT_DIR = path.join(ROOT, 'tmp', 'manus-shift60-vocab-gaps-wave46');
...
const dumpBase = { started_at: new Date().toISOString(), agent_profile: profile, force_skills: force, quality: 'default', wave: 46, shift: 60 };
...
const created = await createTask({
  title: 'ESL white vocab 3×3: Shift60 vocab-gaps wave46 (breakfast/vet/photo)',
  message: BRIEF,
