/**
 * Shift60 vocab-gaps wave31 — breakfast + doctor kit + birthday extras.
 *   node scripts/manus/request-shift60-vocab-gaps-wave31.mjs
 */
import fs from 'fs';
...
const OUT_DIR = path.join(ROOT, 'tmp', 'manus-shift60-vocab-gaps-wave31');
...
const dumpBase = { started_at: new Date().toISOString(), agent_profile: profile, force_skills: force, quality: 'default', wave: 31, shift: 60 };
...
const created = await createTask({
  title: 'ESL white vocab 3×3: Shift60 vocab-gaps wave31 (breakfast/doctor/birthday)',
  message: BRIEF,
