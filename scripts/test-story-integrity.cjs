...
// Who+possession: coach+whistle co-mention is NOT enough without a link verb (Manus soccer S73)
const whistleLoose = {
  vocabulary: [{ word: 'coach' }, { word: 'whistle' }],
  story: {
    pages: [{ text: 'The coach smiles. The whistle is ready.' }],
    comprehensionQuestions: [
      { question: 'Who has the whistle?', sampleAnswer: 'The coach.' },
    ],
  },
};
...
const whistleLinked = {
  vocabulary: [{ word: 'coach' }, { word: 'whistle' }],
  story: {
    pages: [{ text: 'The coach has the whistle. The whistle is ready.' }],
    comprehensionQuestions: [
      { question: 'Who has the whistle?', sampleAnswer: 'The coach.' },
    ],
  },
