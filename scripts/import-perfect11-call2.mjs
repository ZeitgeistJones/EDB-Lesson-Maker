/**
 * Stage + merge Perfect11 Call 2 black-field sheets (5 × 4×8 / import --grid=8x4).
 *
 *   node scripts/import-perfect11-call2.mjs
 */
import fs from 'fs';
...
const NAMES = JSON.parse(
  fs.readFileSync(path.join(ROOT, 'scripts/fixtures/perfect11-call2-names.json'), 'utf8'),
);
...
const IMPORT_SHEETS = [
  { file: '01-sheet_6_pirates.png', pack: 'pirates', prefix: 'pirate-', namesKey: 'pirates' },
  { file: '02-sheet_7_fire_station.png', pack: 'fire-station', prefix: 'fire-', namesKey: 'fire-station' },
  { file: '03-sheet_8_volcano_geology.png', pack: 'volcano-geology', prefix: 'volcano-', namesKey: 'volcano-geology' },
  { file: '04-sheet_9_recycling_eco.png', pack: 'recycling-eco', prefix: 'eco-', namesKey: 'recycling-eco' },
  { file: '05-sheet_10_planetarium.png', pack: 'planetarium', prefix: 'planet-', namesKey: 'planetarium' },
];
...
const SRC_DIR = path.join(ROOT, 'tmp', 'manus-perfect11-call2');
const STAGE_ROOT = path.join(ROOT, 'tmp', 'manus-import-perfect11-call2');
