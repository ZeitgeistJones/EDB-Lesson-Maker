...
| Board backgrounds (scenes) | `08_backgrounds/img/` (non-flat) | Generated with OpenAI image models for this project | Verify OpenAI terms before commercial resale | 60 place scenes with `groundY` (home, travel, street, outdoor, medical, commercial, school + hotel, office, stadium, party, winter, train, vet, water park, swamp, polar, reef, buffet, ballroom, ice rink, haunted, moon, dorm, gymnastics, river, dock); clear centre band for pieces | 2026-08-04 |
