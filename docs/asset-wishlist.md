...
| 2026-08-07 | Vocab icons: music unit (`drum`, `sing`, `dance`, `song` distinct from `piano`) | music fixture M7 — piano.png reused for music/piano/song | Vocab pack | Art mode / sheet | open |
| 2026-08-07 | Vocab icon: `room` (hotel unit) | hotel fixture unvetted Gemini glyph | Vocab pack | Art mode | open |
