...
- **Hard fails:** 0 → 0 (→)
- **Soft metric fails:** 18 → 3 (↑-15)
- **Soft metric warns:** 145 → 139 (↑-6)
- **M5 variety fails:** 10 → 0 (↑-10)
- **M7 vocab-art fails:** 3 → 3 (→)
- **Layout soft fails (M8/M9/M10):** 5 → 0 (↑-5)
- **Unvetted vocab words:** 26 → 26 (→)
- **Open wishlist rows:** 7 → 9 (↓+2)
- **Mean M5 (variety):** 0.363 → 0.533 (↑+0.17)
- **Mean M7 (vetted art):** 0.767 → 0.767 (→)
