...
- 2026-08-04 iter 1 (all) — **wishlist** M7 · hard 0 · metric 4 fail / 12 warn · roots: no-vetted-icon · asset gap logged
- 2026-08-05 iter 2 (core) — **fix_soft** R1 · hard 0 · metric 0 fail / 5 warn · roots: ink-policy-measured-no-scrim-on-calm, no-medical-props, no-gym-props, no-vetted-icon
