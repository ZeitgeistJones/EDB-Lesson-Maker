...
## Final producer fold after Round 3

- FINAL_BASELINE: `tmp/board-type-baselines/capacityPack.jpg`
- LOOP_STATUS: `producer_fixed_after_3_round_cap`
- LATEST_MANUS_STATUS: `fail_on_pre-fold-R3-render`
- LOCAL_STATUS: `rendered_and_grammar_tests_pass`
...
- FIX: The board now carries both reusable language frames: `I pack ___ because ___.` and `I leave out ___ because ___.`
